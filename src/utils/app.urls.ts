...
export const DESPATCHSUMMARYREPORT = BASEURL + 'Reports/GenerateDespatchSummaryReport';
export const PCBDETAILSREPORT = BASEURL + 'Reports/GeneratePCBDetailsReport';
...
export const STOCKITEMDETAILSREPORT = BASEURL + 'Reports/GenerateStockItemDetailsReport';
export const BATCHDETAILSREPORT = BASEURL + 'Reports/GenerateBatchDetailsReport';
export const STOCKISSUEREGISTER = BASEURL + 'Reports/GenerateStockIssueRegister';
export const SUPPLIERDUEFORREVIEWREPORT = BASEURL + 'Reports/GenerateSupplierDueForReviewReport';
export const UPDATESUPPLIERREVIEWDETAILS = BASEURL + 'Masters/UpdateSupplierReviewDetails';
...
export const GETPENDINGRETURANBLEDCLIST = BASEURL + 'Transactions/GetPendingReturanbleDCList';