...
export class TransactionFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.transItemDetails = JSON.parse(
      localStorage.getItem("transItemDetails")
    );
    this.transLedgerDetails = JSON.parse(
      localStorage.getItem("transLedgerDetails")
    );
    ...
    this.transBatchDetails = JSON.parse(
      localStorage.getItem("transBatchDetails")
    );
    this.transGRNTerms = JSON.parse(localStorage.getItem("transGRNTerms"));
    this.transInvoiceTerms = JSON.parse(
      localStorage.getItem("transInvoiceTerms")
    );
    this.transWorkCompletionDetails = JSON.parse(
      localStorage.getItem("transWorkCompletionDetails")
    );
    ...
    this.transationLinkRef = JSON.parse(
      localStorage.getItem("transationLinkRef")
    );
    this.showLocation = JSON.parse(localStorage.getItem("showLocation"));
    this.transactionTypeId = JSON.parse(
      localStorage.getItem("transactionTypeId")
    );
    this.barcodeFields = JSON.parse(localStorage.getItem("barcodeFields"));
    this.showTransactionSeries = JSON.parse(
      localStorage.getItem("showTransactionSeries")
    );
    this.showPO = JSON.parse(localStorage.getItem("showPO"));
    this.showBarcode = JSON.parse(localStorage.getItem("showBarcode"));
    this.transationLinkRefInput = JSON.parse(
      localStorage.getItem("transationLinkRefInput")
    );
    this.transationLinkRefNamePO = JSON.parse(
      localStorage.getItem("transationLinkRefNamePO")
    );
    ...
    setTimeout(() => {
      if (!this.isEmpty(this.detailsData)) {
        if (
          this.detailsData[0].transactionDate == "" ||
          this.detailsData[0].transactionDate == null
        ) {
  ...
  get transactionBoxSerialNo() {
    return this.transactionForm.get(["transBoxDetails"], 0, [
      "transactionBoxSerialNo"
    ]);
  }
  get boxPosition() {
  ...
  get transporterLedgerID() {
    return this.transactionForm.get(["transInvoiceTerms"], 0, [
      "transporterLedgerID"
    ]);
  }
  get transporterLRNO() {
  ...
  get jobCompletionDate() {
    return this.transactionForm.get(["transWorkCompletionDetails"], 0, [
      "jobCompletionDate"
    ]);
  }
  get departmentName() {
  ...
  get transactionItem_AdditionalDesciption() {
    return this.transactionForm.get(["transItemDetails"], 0, [
      "transactionItem_AdditionalDesciption"
    ]);
  }
  get itemQty() {
  ...
  addItemLedger() {
    const ledgerArray = <FormArray>(
      this.transactionForm.get("transLedgerDetails")
    );
    ledgerArray.push(
      this.fb.group({
        transactionID: [0],
  ...
  get ledgerAmount() {
    return this.transactionForm.get(["transLedgerDetails"], 0, [
      "ledgerAmount"
    ]);
  }
  ...
  get transactionTransporter() {
    return this.transactionForm.get(["transPOTerms"], 0, [
      "transactionTransporter"
    ]);
  }
    ...
    if (id > 0) {
      this.trasactionService.getTransactionDetails(id).subscribe(res => {
        if (res.status === "200") {
          ...
          this.transactionForm.controls["transactionID"].setValue(
            this.detailsData[0].transactionID
          );
          this.transactionForm.controls["transactionDate"].setValue(
            this.convertToDateFormat(this.detailsData[0].transactionDate)
          );
          this.transactionForm.controls["transactionNo"].setValue(
            this.detailsData[0].transactionNo
          );
          this.transactionForm.controls["poNo"].setValue(
            this.detailsData[0].poNo
          );
          this.transactionForm.controls["transactionTypeId"].setValue(
            this.detailsData[0].transactionTypeId
          );
          this.transactionForm.controls["transactionSeriesID"].setValue(
            this.detailsData[0].transactionSeriesID
          );
          this.transactionForm.controls["ledgerID"].setValue(
            this.detailsData[0].ledgerID
          );
          this.transactionForm.controls["transactionLinkID"].setValue(
            this.detailsData[0].transactionLinkID
          );
          this.transactionForm.controls["transactionLinkRef"].setValue(
            this.detailsData[0].transactionLinkRef
          );
          this.transactionForm.controls["companyID"].setValue(
            this.detailsData[0].companyID
          );
          this.transactionForm.controls["locationID"].setValue(
            this.detailsData[0].locationID
          );
          this.transactionForm.controls["transaction_Remarks"].setValue(
            this.detailsData[0].transaction_Remarks
          );
          this.transactionForm.controls["transaction_Amount"].setValue(
            this.detailsData[0].transaction_Amount
          );
          this.transactionForm.controls["transaction_PendingAmount"].setValue(
            this.detailsData[0].transaction_PendingAmount
          );
          this.transactionForm.controls["currencyID"].setValue(
            this.detailsData[0].currencyID
          );
          this.transactionForm.controls["ledaddid"].setValue(
            this.detailsData[0].ledaddid
          );
          ...
          if (
            this.detailsData[0].transItemDetails.length > 0 &&
            this.transItemDetails
          ) {
            ...
            for (
              ...
              formArray.push(
                this.fb.group({
                  transactionID: [
                    this.detailsData[0].transItemDetails[i].transactionID
                  ],
                  stockitemID: [
                    this.detailsData[0].transItemDetails[i].stockitemID
                  ],
                  stockItemDesc: [
                    this.detailsData[0].transItemDetails[i].stockItemDesc
                  ],
                  transactionItem_AdditionalDesciption: [
                  ...
                  itemReceived_Qty: [
                    this.detailsData[0].transItemDetails[i].itemReceived_Qty
                  ],
                  itemChallan_Qty: [
                    this.detailsData[0].transItemDetails[i].itemChallan_Qty
                  ],
                  itemPending_Qty: [
                    this.detailsData[0].transItemDetails[i].itemPending_Qty
                  ],
                  itemRate: [this.detailsData[0].transItemDetails[i].itemRate],
                  itemAmount: [
                    this.detailsData[0].transItemDetails[i].itemAmount
                  ],
                  itemStops: [
                    this.detailsData[0].transItemDetails[i].itemStops
                  ],
                  itemLength: [
                    this.detailsData[0].transItemDetails[i].itemLength
                  ],
                  itemEndLendth: [
                    this.detailsData[0].transItemDetails[i].itemEndLendth
                  ],
                  itemStartLength: [
                    this.detailsData[0].transItemDetails[i].itemStartLength
                  ],
                  itemBatchApplicable: [
                    this.detailsData[0].transItemDetails[i].itemBatchApplicable
                  ],
                  packingBoxStockItemID: [
                    this.detailsData[0].transItemDetails[i]
                      .packingBoxStockItemID
                  ],
                  transactionItemSerialNo: [
                    this.detailsData[0].transItemDetails[i]
                      .transactionItemSerialNo
                  ],
                  itemBarCodeApplicableStatus: [
                  ...
                  itemBarCodeLength: [
                    this.detailsData[0].transItemDetails[i].itemBarCodeLength
                  ]
                })
              );

              this.barCodeApplicableStatus.push({
                status: this.detailsData[0].transItemDetails[i]
                  .itemBarCodeApplicableStatus
              });
            }
            this.checkQty();
          ...
          if (
            this.detailsData[0].transPOTerms.length > 0 &&
            this.transPOTerms
          ) {
            this.POData = this.detailsData[0].transPOTerms;
            const controlArray = <FormArray>(
              this.transactionForm.get("transPOTerms")
            );
            controlArray.controls[0]
              .get("transactionDeilveryTerms")
              .setValue(this.POData[0].transactionDeilveryTerms);
            controlArray.controls[0]
              .get("transactionTransporter")
              .setValue(this.POData[0].transactionTransporter);
            controlArray.controls[0]
              .get("transctionSupplierRef")
              .setValue(this.POData[0].transctionSupplierRef);
            controlArray.controls[0]
              .get("transactionPackingTerms")
              .setValue(this.POData[0].transactionPackingTerms);
            controlArray.controls[0]
              .get("transactionPaymentTerms")
              .setValue(this.POData[0].transactionPaymentTerms);
            controlArray.controls[0]
              .get("transactionFreightTerms")
              .setValue(this.POData[0].transactionFreightTerms);
            controlArray.controls[0]
              .get("transactionDueDate")
              .setValue(
                this.convertToDateFormat(this.POData[0].transactionDueDate)
              );
          ...
          if (
            this.detailsData[0].transLedgerDetails.length > 0 &&
            this.transLedgerDetails
          ) {
            const ledgerArray = <FormArray>(
              this.transactionForm.get("transLedgerDetails")
            );
            ...
            for (
              let i = 0;
              i < this.detailsData[0].transLedgerDetails.length;
              i++
            ) {
              ledgerArray.push(
                this.fb.group({
                  transactionID: [
                    this.detailsData[0].transLedgerDetails[i].transactionID
                  ],
                  ledgerID: [
                    this.detailsData[0].transLedgerDetails[i].ledgerID
                  ],
                  taxRate: [this.detailsData[0].transLedgerDetails[i].taxRate],
                  ledgerAmount: [
                    this.detailsData[0].transLedgerDetails[i].ledgerAmount
                  ]
                })
              );
            }
          ...
          if (
            this.detailsData[0].transBoxDetails.length > 0 &&
            this.transBoxDetails
          ) {
            this.boxDetailData = this.detailsData[0].transBoxDetails;
            const controlArray = <FormArray>(
              this.transactionForm.get("transBoxDetails")
            );
            ...
            for (let i = 0; i < this.boxDetailData.length; i++) {
              controlArray.push(
                this.fb.group({
                  ...
                  transactionBoxSerialNo: [
                    this.boxDetailData[i].transactionBoxSerialNo
                  ],
          ...
          if (
            this.detailsData[0].transBatchDetails.length > 0 &&
            this.transBatchDetails
          ) {
          ...
          if (
            this.detailsData[0].transGRNTerms.length > 0 &&
            this.transGRNTerms
          ) {
            this.GRNTermsData = this.detailsData[0].transGRNTerms;
            const controlArray = <FormArray>(
              this.transactionForm.get("transGRNTerms")
            );
            controlArray.controls[0]
              .get("inwardNo")
              .setValue(this.GRNTermsData[0].inwardNo);
            controlArray.controls[0]
              .get("transporter")
              .setValue(this.GRNTermsData[0].transporter);
            controlArray.controls[0]
              .get("dcNo")
              .setValue(this.GRNTermsData[0].dcNo);
            controlArray.controls[0]
              .get("dcDate")
              .setValue(this.GRNTermsData[0].dcDate);
            controlArray.controls[0]
              .get("invoiceNo")
              .setValue(this.GRNTermsData[0].invoiceNo);
            controlArray.controls[0]
              .get("invoiceDate")
              .setValue(this.GRNTermsData[0].invoiceDate);
            controlArray.controls[0]
              .get("inwardDate")
              .setValue(this.GRNTermsData[0].inwardDate);
          }

          if (
            this.detailsData[0].transInvoiceTerms.length > 0 &&
            this.transInvoiceTerms
          ) {
            this.invoiceTermData = this.detailsData[0].transInvoiceTerms;
            const controlArray = <FormArray>(
              this.transactionForm.get("transInvoiceTerms")
            );
            controlArray.controls[0]
              .get("transporterLedgerID")
              .setValue(this.invoiceTermData[0].transporterLedgerID);
            controlArray.controls[0]
              .get("transporterLRNO")
              .setValue(this.invoiceTermData[0].transporterLRNO);
            controlArray.controls[0]
              .get("transporterLRDate")
              .setValue(this.invoiceTermData[0].transporterLRDate);
            controlArray.controls[0]
              .get("transporterGSTIN")
              .setValue(this.invoiceTermData[0].transporterGSTIN);
            controlArray.controls[0]
              .get("GSTEwayBillNo")
              .setValue(this.invoiceTermData[0].GSTEwayBillNo);
            controlArray.controls[0]
              .get("GSTEWayBillDate")
              .setValue(this.invoiceTermData[0].GSTEWayBillDate);
          }

          if (
            this.detailsData[0].transWorkCompletionDetails.length > 0 &&
            this.transWorkCompletionDetails
          ) {
            this.workCompletionData = this.detailsData[0].transWorkCompletionDetails;
            const controlArray = <FormArray>(
              this.transactionForm.get("transWorkCompletionDetails")
            );
            controlArray.controls[0]
              .get("jobCompletionDate")
              .setValue(this.workCompletionData[0].jobCompletionDate);
            controlArray.controls[0]
              .get("departmentName")
              .setValue(this.workCompletionData[0].departmentName);
            controlArray.controls[0]
              .get("transctionJobWorkRemarks")
              .setValue(this.workCompletionData[0].transctionJobWorkRemarks);
            controlArray.controls[0]
              .get("location")
              .setValue(this.workCompletionData[0].location);
            controlArray.controls[0]
              .get("bllAmount")
              .setValue(this.workCompletionData[0].billAmount);
            controlArray.controls[0]
              .get("materialAmount")
              .setValue(this.workCompletionData[0].materialAmount);
            controlArray.controls[0]
              .get("labourAmount")
              .setValue(this.workCompletionData[0].labourAmount);
          }
        }
  ...
  saveTransation(formData) {
    if (this.transactionForm.valid) {
      ...
      formData.transactionDate = this.convertDateyymmdd(
        ...
        for (let key in data) {
          if (data.hasOwnProperty(key)) {
            this.currencyList.push({
              label: data[key].currencyName,
              value: data[key].currencyID
            });
          }
        }
      }
        ...
        for (let key in data) {
          if (data.hasOwnProperty(key)) {
            this.supplierList.push({
              label: data[key].supplierName,
              value: data[key].supplier_ID
            });
          }
        }
      }
  ...
  getSelectedVal(event, elem, index) {
    ...
    for (let i = 0; i < this.itemMasterList.length; i++) {
      if (this.itemMasterList[i].label === event) {
        itemListArray.controls[index]
          .get("stockitemID")
          .setValue(this.itemMasterList[i].value);
        ...
        for (let key in data) {
          if (data.hasOwnProperty(key)) {
            this.locationList.push({
              label: data[key].locationName,
              value: data[key].locationID
            });
          }
        }
      }
  ...
  getTaxRate(data, i) {
    const ledgerfrmArray = <FormArray>(
      this.transactionForm.get("transLedgerDetails")
    );
    ledgerfrmArray.controls[i]
      .get("taxRate")
      .setValue(data.selectedOption.rateofTax);
    this.getAmount();
  }

  // GET TOTAL AMOUNT //
  getAmount() {
    const itemfrmArray = <FormArray>(
      this.transactionForm.get("transItemDetails")
    );
  ...
  getSelectLinkRef(event) {
    if (event.value !== undefined) {
      this.trasactionService
        .getTransactionDetails(event.value)
        .subscribe(res => {
          if (res.status === "200") {
            this.detailsData = res.data;
            this.totalAmount = this.detailsData[0].transaction_Amount;
              ...
              for (var i = 0; i < this.ItemData.length; i++) {
                controlArray.push(
                  this.fb.group({
                    ...
                    transactionItem_AdditionalDesciption: [
                      this.ItemData[i].transactionItem_AdditionalDesciption
                    ],
                    itemQty: [0],
                    ...
                    packingBoxStockItemID: [
                      this.ItemData[i].packingBoxStockItemID
                    ],
                    transactionItemSerialNo: [
                      this.ItemData[i].transactionItemSerialNo
                    ],
                ...
                this.barCodeApplicableStatus.push({
                  status: this.ItemData[i].itemBarCodeApplicableStatus
                });
              }
              this.checkQty();
            }
      ...
      if (batchCode.length === 7) {
        ...
        for (var i = 0; i < controlArray.length; i++) {
          ...
          if (inputItemCode === stockItem) {
            this.grnItemIndex = i;
            let currentLength = controlArray.controls[i].get("itemLength")
              .value;
            ...
            let scanQty = controlArray.controls[i].get("itemReceived_Qty")
              .value;
  ...
  calculateLength() {
    ...
    const currentItemLength = controlArray.controls[this.grnItemIndex].get(
      "itemLength"
    ).value;
    const currentItemStops = controlArray.controls[this.grnItemIndex].get(
      "itemStops"
    ).value;
    ...
    if (itemStartLength == null || itemStartLength == "") {
      ...
      controlArray.controls[this.grnItemIndex]
        .get("itemStartLength")
        .setValue(JSON.parse(itemStartLength));
      controlArray.controls[this.grnItemIndex]
        .get("itemEndLendth")
        .setValue(JSON.parse(itemEndLength));
      this.plValidationMsg = "";
  ...
  validateBatch(itemcode, batchcode, index, scanQty, qty) {
    ...
    this.trasactionService
      .validateBatch(itemcode, batchcode, 2)
      .subscribe(res => {
        if (res.status === "200") {
          let data = res.data;
          ...
          controlArray.controls[index]
            .get("itemQty")
            .setValue(JSON.parse(qty) + existingQty);
  ...
  getTransactionTypeSeries() {
    this.trasactionService.getTransactionTypeSeries().subscribe(res => {
      if (res && res.status === "200") {
        ...
        for (let key in data) {
          if (data.hasOwnProperty(key)) {
            this.transactionTypeSeriesList.push({
              label: data[key].seriesName,
              value: data[key].transactionSeriesID
            });
          }
        }
      }
  ...
  getLedgerLocation(ledgerId) {
    ...
    this.trasactionService.getLedgerLocation(ledgerId).subscribe(res => {
      if (res && res.status === "200") {
        ...
        for (let key in data) {
          if (data.hasOwnProperty(key)) {
            this.ledgerLocationList.push({
              label: data[key].ledgerLocationName,
              value: data[key].locationID
            });
          }
        }
