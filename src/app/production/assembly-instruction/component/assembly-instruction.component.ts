...
export class AssemblyInstructionComponent implements OnInit, OnDestroy {
    ...
    exportAsXLSX():void {
      if(this.ai && this.ai['assemblyInstructionDetails'].length > 0)
      this.exportAsExcelFile(this.ai['assemblyInstructionDetails'], this.capitalizeFirstLetter('FG Planning Item Details'));
    }
