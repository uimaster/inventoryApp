...
export class PurchaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.sales = [
      { code: '0215', itemName: 'MMM', desc: 'Good for this', qty: '3', packing: '0.00', noprPkg: '0.00',
       rate: '235.25',  amount: '8954.23' },
      { code: '3325', itemName: 'TTT', desc: 'Good for this', qty: '5', packing: '0.00', noprPkg: '0.00',
       rate: '5576.99', amount: '265493.25' },
      { code: '0215', itemName: 'MMM', desc: 'Good for this', qty: '3', packing: '0.00', noprPkg: '0.00',
       rate: '235.25',  amount: '8954.23' },
      { code: '3325', itemName: 'TTT', desc: 'Good for this', qty: '5', packing: '0.00', noprPkg: '0.00',
       rate: '5576.99', amount: '265493.25' },
